package org.firstinspires.ftc.teamcode.drivers; // Adjust package to your team's structure
...
//        super.registerArmingStateCallback(false);  // Deals with USB cables getting unplugged
    ...
    {
        // Check if the magnet is detected.  This is a good way to verify basic
...
//        return isMagnetDetected();
    ...
    public void setStartPositionToZero() throws InterruptedException {
        short rawAngle;

        rawAngle = getRawAngle();  // read current raw angle
        writeShort(Register.REGISTER_ZPOS_HIGH, rawAngle);  // set the start position to the current raw angle
        Thread.sleep(10);

        // set the stop position to the current raw angle - 1
        if (rawAngle == 0) {
        ...
        // Burn the start and stop positions
        // Burning is limited to 3 times.  So, deferring this feature for now.
    }
